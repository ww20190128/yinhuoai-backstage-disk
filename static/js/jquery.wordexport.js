if (typeof jQuery !== "undefined" && typeof saveAs !== "undefined") {
    (function ($) {
        $.fn.wordExport = function (fileName) {
            ...
            var styles = '.item-body {position: relative;font-size: 13px;margin-bottom: 10px;color: #333;line-height: 1.6;} .title1 {font-size: 18px;font-weight: bolder;} .title2 {font-size: 16px;font-weight: bold;} .title3 {font-size: 16px;} .item-p {margin-bottom: 10px;line-height: 1.6;} .question-p {margin-bottom: 4px;}'
